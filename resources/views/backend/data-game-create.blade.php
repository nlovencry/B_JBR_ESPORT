              ...
              <form method="POST" action="{{ route('datagame.store') }}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Nama Game" name="nama_game" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputKet">Keterangan</label>
                    <textarea name="keterangan" id="" rows="7" class="form-control" required></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
